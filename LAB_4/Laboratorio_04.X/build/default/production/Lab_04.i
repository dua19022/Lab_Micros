...
; CONFIG1
  CONFIG FOSC = INTRC_CLKOUT ; Oscillator Selection bits (XT oscillator: Crystal/resonator on ((PORTA) and 07Fh), 6/OSC2/CLKOUT and ((PORTA) and 07Fh), 7/OSC1/CLKIN)
...
resetD macro ; Reset del timer0
    btfss ((INTCON) and 07Fh), 2 ; overflow timer0
...
main:
    ...
    movlw 00000011B ; Activar las interrupciones en ((PORTB) and 07Fh), 0 y ((PORTB) and 07Fh), 1
    movwf IOCB
    ...
    bsf ((INTCON) and 07Fh), 7 ; Interrupcion global
    bsf ((INTCON) and 07Fh), 3 ; Interrupcion puerto b
    bsf ((INTCON) and 07Fh), 5 ; Interrupcion timer0
    bcf ((INTCON) and 07Fh), 2
...
clock: ; Se configura el oscilador interno
    BANKSEL OSCCON
    bcf ((OSCCON) and 07Fh), 6 ; Se selecciona 010
    bsf ((OSCCON) and 07Fh), 5
    bcf ((OSCCON) and 07Fh), 4 ; Frecuencia de 250 KHz
