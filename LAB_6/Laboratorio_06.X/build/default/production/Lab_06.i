...
main:
    ...
    BANKSEL PIE1
    bsf ((PIE1) and 07Fh), 1 ;habilita timer2 para pr2
    bsf ((PIE1) and 07Fh), 0 ;habilita timer1 interrupcion por overflow

    BANKSEL PIR1
    bcf ((PIR1) and 07Fh), 1 ;limpiar banderas para timer2
    bcf ((PIR1) and 07Fh), 0 ;limpiar banderas de interrupcion para tiemr 1
    ;**************************************************************************
